...
class Stats():
    ...
    def message_track(self, rnd, decoded_objects, gossip_objects):
        ...
        elif rnd in self.last_message_exists and self.last_message_exists[rnd] == True:
            return
